...
<div className="my-6 space-y-4 text-sm">
  ...
  <div className="rounded-lg border bg-fd-card p-4">
    ...
    <div className="grid grid-cols-3 gap-3 text-center">
      ...
      <div className="rounded-md border bg-fd-background px-3 py-2">Protocol Handlers<br/><span className="text-fd-muted-foreground text-xs">HTTP, BT (risuko-bt), ED2K/Kad, Usenet/NZB, M3U8, FTP/SFTP, Media (yt-dlp), ADC/DC, Gnutella, G2, giFT, RSS, Upload Sinks</span></div>
      ...
      <div className="rounded-md border bg-fd-background px-3 py-2">Stats Manager<br/><span className="text-fd-muted-foreground text-xs">desktop download-history samples</span></div>
