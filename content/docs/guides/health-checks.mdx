...
| `network` | BT and DHT listen-port configuration, ED2K Kad UDP binding and bootstrap state, IPv6 listener flag, proxy URL validity and reachability (slow probe) |
