...
```js
import { startEngine, addUri, onEvent, stopEngine } from "risuko-js";
...
```js
import { startEngine, changeGlobalOption, addUri, onEvent } from "risuko-js";
...
```js
import { startEngine, changeGlobalOption } from "risuko-js";
