...
See the [Proxy Support guide](/docs/guides/proxy) for URL schemes, scopes, and bypass syntax.
...
| `pbh-enable` | `false` | Start a second JSON-RPC listener in Aria2Next compatibility mode so [PeerBanHelper](https://github.com/PBH-BTN/PeerBanHelper) can monitor and ban BitTorrent peers (engine restart) |
